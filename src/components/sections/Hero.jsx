...
const HERO_SKILLS = [
    ...
    { name: 'TypeScript', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg', x: -160, y: 0 },
    { name: 'Docker', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg', x: -100, y: 140 },
    { name: 'AWS', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/amazonwebservices/amazonwebservices-original-wordmark.svg', x: 100, y: 140 },
];
    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-gradient-to-b from-indigo-50/50 to-white dark:from-slate-950 dark:to-slate-950">
            ...
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                ...
                {/* Tech Stack Animation - Featuring actual skill icons */}
                <motion.div
                ...
                >
                    ...
                    <div className="relative z-10">
                        <div className="w-36 h-36 bg-white/90 dark:bg-slate-900 rounded-full flex flex-col items-center justify-center border-4 border-white dark:border-slate-800 shadow-[0_0_60px_-15px_rgba(99,102,241,0.4)] dark:shadow-none relative z-10 backdrop-blur-sm">
                    ...
                    {HERO_SKILLS.map((skill, index) => (
                        <motion.div
                            key={skill.name}
                            className="absolute p-3 bg-white/95 dark:bg-slate-800/95 rounded-xl shadow-lg shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-700 z-20 backdrop-blur-sm flex flex-col items-center gap-1 group hover:scale-110 transition-transform cursor-default"
                            animate={{
                        ...
                        >
                            ...
                            />
                            <span className="text-[10px] font-medium text-slate-600 dark:text-slate-300 opacity-80 group-hover:opacity-100">
                                {skill.name}
                            </span>
                        </motion.div>
                    ))}
