...
export const SKILLS: SkillCategories = {
    Frontend: [
        ...
        { name: 'Material UI', level: 85, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/materialui/materialui-original.svg' },
    ...
    Backend: [
        ...
        { name: 'C', level: 70, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/c/c-original.svg' },
        { name: 'Nginx', level: 75, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nginx/nginx-original.svg' },
        { name: 'Telegram APIs', level: 85, icon: 'https://upload.wikimedia.org/wikipedia/commons/8/82/Telegram_logo.svg' }
    ],
    Database: [
        { name: 'MongoDB', level: 90, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg' },
        { name: 'Mongoose', level: 90, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongoose/mongoose-original.svg' },
        { name: 'MySQL', level: 75, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg' },
        { name: 'Firestore', level: 70, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firebase/firebase-plain.svg' },
    ...
    Tools: [
        ...
        { name: 'Docker & K8s', level: 75, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg' },
        { name: 'AWS (EC2/S3)', level: 70, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/amazonwebservices/amazonwebservices-original-wordmark.svg' },
        { name: 'CI/CD', level: 70, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/githubactions/githubactions-original.svg' },
